...
window.saveBlocks = function() {
    ...
    formData.push({ name: 'use_manual_schedule', value: $('#use_manual_schedule').is(':checked') ? '1' : '0' });
    formData.push({ name: 'manual_schedule_date', value: $('#manual_schedule_date').val() });
    formData.push({ name: 'manual_schedule_time', value: $('#manual_schedule_time').val() });
    formData.push({ name: 'custom_header', value: $('#custom_header').val() });
    formData.push({ name: 'custom_footer', value: $('#custom_footer').val() });
