...
// Retrieve all available PDF templates from the standardized 'newsletter_templates' option
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['settings_nonce']) || !wp_verify_nonce($_POST['settings_nonce'], 'save_settings_action')) {
        ...
        if (!empty($raw_time)) {
            ...
            // Store this UTC conversion as a reference option (if needed by your scheduling logic)
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="newsletter_pdf_template_id" name="newsletter_pdf_template_id" <?php echo ($opt_into_pdf ? '' : 'disabled'); ?>>
                                ...
                                <?php
                                // Now pulling templates from newsletter_templates
                                if (!empty($templates) && is_array($templates)) {
                                    foreach ($templates as $index => $template_item) {
                                        if ($index === 'default') {
                                            // Already displayed as "Default PDF Template" above
                                            continue;
                                        }
