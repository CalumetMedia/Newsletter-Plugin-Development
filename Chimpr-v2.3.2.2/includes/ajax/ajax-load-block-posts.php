...
function newsletter_load_block_posts() {
    ...
    $posts_args = [
        ...
        'sort_order'  => 'DESC',
        'posts_per_page' => -1  // Get all posts to properly handle selection
    ];
    ...
    if ($posts) {
        ...
        foreach ($posts as $index => $post) {
            ...
            error_log("Processing post $post_id at index $index with story_count $story_count - checked: $checked, was_selected: " . ($was_selected ? '1' : '0'));
