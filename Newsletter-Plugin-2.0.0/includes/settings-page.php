 ...
 */
function cnp_settings_page_v20() { // Renamed from cnp_settings_page to cnp_settings_page_v20
    ...
    echo '<script>
        ...
        function toggleScheduleFields(checkbox, newsletterId) {
            ...
            const sendDaysRow = document.getElementById("send-days-row-" + newsletterId);
            const sendTimeRow = document.getElementById("send-time-row-" + newsletterId);

            if (sendDaysRow && sendTimeRow) {
                sendDaysRow.style.display = isChecked ? "none" : "table-row";
                sendTimeRow.style.display = isChecked ? "none" : "table-row";
            }
        }
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (activeTab) {
                ...
                const activeNavTab = document.querySelector("[href=\'#" + activeTab + "\']");
                if (activeNavTab) {
