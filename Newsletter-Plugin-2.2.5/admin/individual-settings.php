...
// Debugging: Enable error logging if not already enabled
...
// Check if $newsletter_slug is set
if (!isset($newsletter_slug)) {
    error_log('individual-settings.php: $newsletter_slug is not set.');
    wp_die(__('Newsletter slug is not set.', 'newsletter'));
}
...
<div class="wrap">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo esc_url(NEWSLETTER_PLUGIN_URL . 'admin/css/newsletter-admin.css'); ?>">
        ...
        <div class="settings-container">
            ...
            <div class="settings-section">
                <h2 class="settings-tab mailchimp-tab">
                    <img src="<?php echo esc_url(NEWSLETTER_PLUGIN_URL . 'admin/images/mailchimp-logo.webp'); ?>" alt="<?php esc_attr_e('Mailchimp', 'newsletter'); ?>" style="height: 20px; vertical-align: middle;">
                </h2>
