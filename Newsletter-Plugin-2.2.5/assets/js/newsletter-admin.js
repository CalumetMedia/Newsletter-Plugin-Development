jQuery(document).ready(function($) {
    ...
    function addBlock() {
        const newBlockHtml = `
            <div class="block-item" data-index="${blockIndex}">
                ...
                <!-- Removed the <hr> to eliminate the gray border -->
            </div>
        `;
    ...
    function loadBlockPosts($block, categoryId, currentBlockIndex) {
        ...
        $.ajax({
            ...
            data: {
                ...
                end_date: endDate,
                newsletter_slug: newsletterData.newsletterSlug, // Consistent naming
    ...
    function updatePreview() {
        ...
        formData.push(
            ...
            { name: 'newsletter_slug', value: newsletterData.newsletterSlug }, // Consistent naming
