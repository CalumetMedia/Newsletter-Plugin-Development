                ...
                if ($block['category'] > 0) {
                    ...
                    if ($posts) {
                        ...
                        foreach ($posts as $post) {
                            $post_id = $post->ID;
                            $checked = in_array($post_id, $selected_posts, true) ? 'checked' : '';
                            ...
                            <li data-post-id="<?php echo esc_attr($post_id); ?>">
                                ...
                                <input type="hidden" class="post-order" name="blocks[<?php echo esc_attr($index); ?>][posts][<?php echo esc_attr($post_id); ?>][order]" value="0">
                            </li>
                            <?php
                        }
                        echo '</ul>';
