    ...
    <tr>
        ...
        <td>
            <input type="text" id="campaign_name" name="campaign_name" class="regular-text" 
                   value="<?php echo esc_attr(get_option("newsletter_campaign_name_$newsletter_slug", '')); ?>">
        </td>
    </tr>
    <tr>
        <th scope="row"><label for="subject_line"><?php esc_html_e('Subject Line', 'newsletter'); ?></label></th>
        <td>
            <input type="text" id="subject_line" name="subject_line" class="regular-text" 
                   value="<?php echo esc_attr(get_option("newsletter_subject_line_$newsletter_slug", '')); ?>">
        </td>
    </tr>
    <?php
...
<tr>
    ...
    <td>
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <input type="time" 
                   id="manual_schedule_time" 
                   name="manual_schedule_time" 
                   style="width: 120px;"
                   value="<?php echo esc_attr(get_option("newsletter_manual_schedule_time_$newsletter_slug", '')); ?>">
            <label>
                <input type="checkbox" 
                       id="use_manual_schedule" 
                       name="use_manual_schedule" 
                       <?php checked(get_option("newsletter_use_manual_schedule_$newsletter_slug", false)); ?>>
                            ...
                            <?php if (get_option('mailchimp_api_key')) : ?>
                                <button type="button" class="button button-secondary button-large" id="send-to-mailchimp" style="padding: 10px 20px; font-size: 18px; background:#FFE01B; align-items: center; justify-content: center;">
                                    <img src="<?php echo esc_url(NEWSLETTER_PLUGIN_URL . 'assets/images/mailchimp-logo.webp'); ?>" 
                                         ...
                                         style="height: 45px; display: flex; align-items: center; justify-content: center; margin-right: 5px;">
        ...
        <tr>
            ...
            <td style="display: flex; align-items: center; gap: 15px;">
                ...
                <input type="date" id="end_date" name="end_date" 
                    value="<?php echo isset($_POST['end_date']) ? esc_attr($_POST['end_date']) : date('Y-m-d'); ?>" 
                    style="width: 150px;" />
