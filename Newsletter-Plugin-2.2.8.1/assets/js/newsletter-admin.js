jQuery(document).ready(function($) {
    ...
    // Function to Initialize Sortable for selected posts
    function initializeSortable(block) {
        console.log('Initializing sortable for block:', block);
        var sortableList = block.find('ul.sortable-posts, .sortable-posts');
        console.log('Found sortable list:', sortableList.length);
