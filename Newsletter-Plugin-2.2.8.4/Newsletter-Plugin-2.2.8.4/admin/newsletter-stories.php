...
<div class="button-group" style="flex: 1 1 30%; max-width: 30%; box-sizing: border-box;">
    <div class="buttons">
        ...
        <?php if (get_option('mailchimp_api_key')) : ?>
            <button type="button" class="button button-secondary button-large action-button" id="send-to-mailchimp">
                <img src="<?php echo esc_url(NEWSLETTER_PLUGIN_URL . 'assets/images/mailchimp-logo.webp'); ?>" alt="<?php esc_attr_e('Mailchimp', 'newsletter'); ?>" style="height: 45px;">
            </button>
