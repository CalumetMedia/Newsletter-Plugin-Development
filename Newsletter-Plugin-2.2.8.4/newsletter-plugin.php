<?php
/**
 * Plugin Name:       Chimpr v2.2.8.4
 * Description:       Cleaning up date scheduling based on feedback.  Cleaning up settings section.
 * Version:           2.2.8.4
 * Author:            Jon Stewart
...
define('NEWSLETTER_PLUGIN_VERSION', '2.2.8.3');
